...
-- ============================================================
-- 5B. STUDENT_EXAMINERS JUNCTION TABLE
-- ============================================================
CREATE TABLE IF NOT EXISTS `student_examiners` (
    `id`             INT AUTO_INCREMENT PRIMARY KEY,
    `student_id`     INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `viva_records` (
    ...
    `internal_examiner_status` ENUM('Pending', 'Confirmed') DEFAULT 'Pending',
    `external_examiner_email_date` DATE DEFAULT NULL,
    `external_examiner_status` ENUM('Pending', 'Confirmed') DEFAULT 'Pending',
